...
(function() {
  var Highlight, auto_detect_option, highlightNewMessages, open_menu;
  ...
  Highlight = (function() {
    ...
    Highlight.prototype.add_hud = function() {
      var _this = this;
      this.append("      <div class='GTalkSyntax-HUD'>        <span class='GTalkSyntax-text'>text</span> |        <span class='GTalkSyntax-code'>code</span>        <span class='GTalkSyntax-caret'>          <b></b>        </span>        <ul class='dropdown-menu'>          <li class='GTalkSyntax-share'>            Share Plugin          </li>        </ul>     </div>      ");
